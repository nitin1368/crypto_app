...
function Learn() {
    return (
        <div className="lrn" style={{ backgroundImage: { OIP } }}>
            <br />
            <br />
            <br />
            <br />
            <h2>Cryptocurrencies: A Primer</h2>
            <p>
            ...
            <br />
            <h2>The Problem with Fiat Money</h2>
            <p>
